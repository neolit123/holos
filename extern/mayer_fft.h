#ifndef mayer_fft_included
#define mayer_fft_included
//----------------------------------------------------------------------
...
// ccernn:
//   copy/paste from mayer_ffft.c
//   so we keep our 'tradition' of .h files only :-)
// todo:
//   axFourier.h ???
...
#undef REAL float
//todo:
//  undef other stuff, so we don't risk name/define clashes
//----------------------------------------------------------------------
#endif mayer_fft_included